...
exports.header = function (uri, method, options) {
    ...
    var header = 'Abriva adr="' + credentials.adr +
                 '", ts="' + artifacts.ts +
...
exports.authenticate = function (res, credentials, artifacts, options) {
    ...
    // we could first verify the signature
...
/*
 * credentials is an object with the following keys: 'adr, 'key', 'algorithm'.
...
exports.getBewit = function (uri, options) {
    ...
    var bewit = credentials.adr + '\\' + exp + '\\' + mac + '\\' + options.ext;
